...
public class FormThongKe extends javax.swing.JFrame {
     ...
     */
    repository.ThongKeRepo rp = new ThongKeRepo();
    DefaultTableModel model = new DefaultTableModel();
    DefaultTableModel hoaDonModel = new DefaultTableModel();
    DefaultTableModel hoaDonChiTietModel = new DefaultTableModel();
    ...
    public FormThongKe() {
        ...
        hoaDonModel = (DefaultTableModel) tblBang.getModel();
        hoaDonChiTietModel = (DefaultTableModel) tblBang.getModel();
        ThongKeRepo repo = new ThongKeRepo();
        fillHoaDonToTable(rp.getAll());
    ...
    private void initComponents() {
        ...
        tblBang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Mã nhân viên", "Ngày lập", "Tổng tiền", "Phương thức TT", "Mã SP", "Số lượng", "Doanh thu SP"
            }
        ));
...
//    private void fillHoaDonToTable(List<HoaDon> hoaDons) {
//        hoaDonModel.setRowCount(0); // Xóa các dòng cũ
...
//    }
//
//    private void fillChiTietToTable(List<HoaDonChiTiet> chiTietList) {
//        hoaDonChiTietModel.setRowCount(0); // Xóa các dòng cũ
//        for (HoaDonChiTiet chiTiet : chiTietList) {
//            hoaDonChiTietModel.addRow(new Object[]{
//                chiTiet.getMaSanPham(),
//                chiTiet.getSoLuong(),
//                chiTiet.getDoanhThuSanPham()
//            });
//        }
//    }
    private void fillHoaDonToTable(List<HoaDon> hoaDons) {
